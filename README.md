...
- **Notas** — organizadas em cadernos por espaço (criar, renomear, mover de espaço, excluir, buscar, redimensionar a coluna), editor de texto rico (negrito, itálico, sublinhado, títulos, listas) com atalhos de markdown ao digitar (`# `, `- `, `**negrito**`...), anexos e colagem direta de imagem, fixar, duplicar, exportar como Markdown ou PDF, mover nota entre cadernos (arrastando ou pelo breadcrumb "Espaço › Caderno"), e associação com tarefas.
